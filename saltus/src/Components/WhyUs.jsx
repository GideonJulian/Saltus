  ...
  return (
    <section id="why-choose-us" className="w-full grid place-items-center md:p-6 mb-20 mt-28">
      <div className="bg-[#F8FAFB] md:p-7 rounded-2xl w-[100%] md:w-[90%]">
        ...
        <div className="mt-5">
          <h1 className="text-center m-auto text-[#0b0c0c] text-[25px] font-[700] mb-4 md:w-auto w-[340px] md:text-[48px] leading-[1.2]">
            Align Your Team, Amplify Your Impact
          </h1>
          <p className="text-[#7F8695] text-[14px] max-w-[780px] leading-snug md:text-[17px] m-auto text-center font-[400]">
