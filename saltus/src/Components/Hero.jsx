...
const Hero = () => {
  return (
    <div className="bg-[#f0eeee] min-h-screen flex md:p-16 px-3 pt-20  w-full ">
      <div className="md:mt-48 mt-5">
        ...
        <div className="relative bg-white pl-6 pr-3   py-3 mt-7 rounded-full flex items-center justify-between shadow-lg shadow-[#0D0A2C0F] w-full max-w-[640px] mx-auto">
          {/* Input Field */}
          <input
            type="text"
          ...
          {/* Button */}
          <button className="px-6 md:px-12 py-3 rounded-full bg-primary text-white font-medium text-[16px] whitespace-nowrap">
            Join Waitlist
          </button>
        </div>
      </div>
